...
import com.ermain.webstore.interceptor.ProcessingTimeLogInterceptor;
import com.ermain.webstore.interceptor.PromoCodeInterceptor;



@Configuration
@EnableWebMvc
@ComponentScan("com.ermain.webstore")
public class WebApplicationContextConfig extends WebMvcConfigurerAdapter{
	...
	// Create a Bean to upload images
	@Bean
	...
	// Add Interceptors to the project
	@Override

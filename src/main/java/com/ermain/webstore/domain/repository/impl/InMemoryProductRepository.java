package com.ermain.webstore.domain.repository.impl;
...
public class InMemoryProductRepository implements ProductRepository{
	...
	public void updateStock(String productID, long numOfUnits) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("unitsInStock", numOfUnits);
	...
	public void addProduct(Product product) {
		String SQL = "INSERT INTO PRODUCTS (ID, "
				...
				+ "UNITS_IN_ORDER, "
				+ "DISCONTINUED) " 
				+ "VALUES (:ID, :name, :desc, :price, :manufacturer, :category, :conditional, :inStock, "
		...
		params.put("conditional", product.getConditional());
	...
	private static final class ProductMapper implements RowMapper<Product>{
		public Product mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			product.setConditional(rs.getString("CONDITIONAL"));
